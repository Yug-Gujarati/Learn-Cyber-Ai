...
class QuizScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => QuizProvider(subtopicTitle: subtopicTitle),
  ...
  Widget _buildBody(QuizProvider provider) {
    ...
    } else if (!provider.hasQuiz) {
      return _NoQuizScreen();
    } else if (provider.showResults) {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            TextButton(
              onPressed: () => AppNavigation.NavigationBack(context),
              child: Text(
                'Go Back',
                style: TextStyle(
                  color: Colors.grey[400],
...
// No Quiz Screen
class _NoQuizScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 15.h),
            Text(
              'This topic doesn\'t have a quiz yet',
              style: TextStyle(
                color: Colors.grey[400],
                fontSize: 38.sp,
              ),
...
class _OptionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final provider = context.watch<QuizProvider>();
    final isSelected = provider.currentAnswer == option;
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 20.h),
          ...provider.quizData!.questions.asMap().entries.map((entry) {
...
class _ReviewCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final provider = context.watch<QuizProvider>();
    final question = provider.quizData!.questions[questionIndex];
